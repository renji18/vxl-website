...
function WhyUs() {
  ...
  return (
    <div className="min-h-screen lg:px-20 xl:px-28 flex items-center justify-center">
      <div className="flex px-10 sm:px-20 md:px-28 lg:px-0 flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 xl:gap-24">
        <div className="lg:w-[500px] lg:h-[420px] xl:w-[600px] items-start gap-12 xl:h-[500px] flex flex-col relative justify-between">
          <img
            src={asterisks}
            alt=""
            className="absolute -top-[52px] left-[52px] md:-top-[56px] md:left-[79px] lg:-top-[55px] xl:-top-[58px] lg:left-[157px] scale-50 md:scale-75 lg:scale-90 xl:scale-100 xl:left-[208px] rotate-[110deg]"
          />
